...
// checks if the CloudVersionMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudVersionMessage{}

// CloudVersionMessage struct for CloudVersionMessage
type CloudVersionMessage struct {
...
func (o CloudVersionMessage) MarshalJSON() ([]byte, error) {
...
func (o CloudVersionMessage) ToMap() (map[string]interface{}, error) {
...
type NullableCloudVersionMessage struct {
	value *CloudVersionMessage
	isSet bool
}

func (v NullableCloudVersionMessage) Get() *CloudVersionMessage {
	return v.value
}

func (v *NullableCloudVersionMessage) Set(val *CloudVersionMessage) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudVersionMessage) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudVersionMessage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudVersionMessage(val *CloudVersionMessage) *NullableCloudVersionMessage {
	return &NullableCloudVersionMessage{value: val, isSet: true}
}

func (v NullableCloudVersionMessage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudVersionMessage) UnmarshalJSON(src []byte) error {
	v.isSet = true
