...
type EntitlementsAPIGetEntitlementsRequest struct {
	ctx        context.Context
	ApiService *EntitlementsAPIService
}

func (r EntitlementsAPIGetEntitlementsRequest) Execute() (*ProjectionView, *http.Response, error) {
	return r.ApiService.GetEntitlementsExecute(r)
}

/*
GetEntitlements Projection reports which console apps the CALLER's org may open, and the plan slug that decides it.
...
even while the UI conservatively shows locked.
	...
	@return EntitlementsAPIGetEntitlementsRequest
*/
func (a *EntitlementsAPIService) GetEntitlements(ctx context.Context) EntitlementsAPIGetEntitlementsRequest {
	return EntitlementsAPIGetEntitlementsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *EntitlementsAPIService) GetEntitlementsExecute(r EntitlementsAPIGetEntitlementsRequest) (*ProjectionView, *http.Response, error) {
	var (
