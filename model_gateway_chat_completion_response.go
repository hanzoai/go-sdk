...
type GatewayChatCompletionResponse struct {
	...
	Usage   *GatewayChatCompletionResponseUsage         `json:"usage,omitempty"`
}
...
func (o *GatewayChatCompletionResponse) GetUsage() GatewayChatCompletionResponseUsage {
	if o == nil || IsNil(o.Usage) {
		var ret GatewayChatCompletionResponseUsage
		return ret
	}
	return *o.Usage
}
...
// SetUsage gets a reference to the given GatewayChatCompletionResponseUsage and assigns it to the Usage field.
