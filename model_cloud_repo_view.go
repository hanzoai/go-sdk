...
// checks if the CloudRepoView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudRepoView{}

// CloudRepoView struct for CloudRepoView
type CloudRepoView struct {
...
func (o CloudRepoView) MarshalJSON() ([]byte, error) {
...
func (o CloudRepoView) ToMap() (map[string]interface{}, error) {
...
type NullableCloudRepoView struct {
	value *CloudRepoView
	isSet bool
}

func (v NullableCloudRepoView) Get() *CloudRepoView {
	return v.value
}

func (v *NullableCloudRepoView) Set(val *CloudRepoView) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudRepoView) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudRepoView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudRepoView(val *CloudRepoView) *NullableCloudRepoView {
	return &NullableCloudRepoView{value: val, isSet: true}
}

func (v NullableCloudRepoView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudRepoView) UnmarshalJSON(src []byte) error {
	v.isSet = true
