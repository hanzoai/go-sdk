...
type AiChatCompletionResponse struct {
	...
	Choices []AiChatChoice `json:"choices,omitempty"`
...
// SetChoices gets a reference to the given []AiChatChoice and assigns it to the Choices field.
