...
type GraphAPIGraphSearchRequest struct {
	ctx        context.Context
	ApiService *GraphAPIService
	q          *string
	relation   *string
...
func (r GraphAPIGraphSearchRequest) Q(q string) GraphAPIGraphSearchRequest {
	r.q = &q
	return r
}

// Relation narrows to one relation. Absent matches every relation.
func (r GraphAPIGraphSearchRequest) Relation(relation string) GraphAPIGraphSearchRequest {
	r.relation = &relation
	return r
}
...
*/
func (a *GraphAPIService) GraphSearch(ctx context.Context) GraphAPIGraphSearchRequest {
	return GraphAPIGraphSearchRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *GraphAPIService) GraphSearchExecute(r GraphAPIGraphSearchRequest) (*GraphReadOut, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/graph/search"
