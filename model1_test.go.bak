...
func TestModelNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Model.New(context.TODO(), hanzoai.ModelNewParams{
		LitellmParams: hanzoai.F(hanzoai.ModelNewParamsLitellmParams{
			...
			ConfigurableClientsideAuthParams:           hanzoai.F([]hanzoai.ModelNewParamsLitellmParamsConfigurableClientsideAuthParamUnion{shared.UnionString("string")}),
			...
			MockResponse:                               hanzoai.F[hanzoai.ModelNewParamsLitellmParamsMockResponseUnion](shared.UnionString("string")),
			...
			StreamTimeout: hanzoai.F[hanzoai.ModelNewParamsLitellmParamsStreamTimeoutUnion](shared.UnionFloat(0.000000)),
			TieredPricing: hanzoai.F([]map[string]interface{}{{
				"foo": "bar",
			}}),
			Timeout:           hanzoai.F[hanzoai.ModelNewParamsLitellmParamsTimeoutUnion](shared.UnionFloat(0.000000)),
			...
			VertexCredentials: hanzoai.F[hanzoai.ModelNewParamsLitellmParamsVertexCredentialsUnion](shared.UnionString("string")),
