...
type ReleasesAPIGetReleasesRequest struct {
	ctx        context.Context
	ApiService *ReleasesAPIService
}

func (r ReleasesAPIGetReleasesRequest) Execute() (*ReleaseBoard, *http.Response, error) {
	return r.ApiService.GetReleasesExecute(r)
}

/*
GetReleases Returns the versions that actually reached the cluster.
...
validated principal; 403 without one.
	...
	@return ReleasesAPIGetReleasesRequest
*/
func (a *ReleasesAPIService) GetReleases(ctx context.Context) ReleasesAPIGetReleasesRequest {
	return ReleasesAPIGetReleasesRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ReleaseBoard
func (a *ReleasesAPIService) GetReleasesExecute(r ReleasesAPIGetReleasesRequest) (*ReleaseBoard, *http.Response, error) {
	var (
