...
// checks if the SubscriptionsOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionsOut{}

// SubscriptionsOut struct for SubscriptionsOut
type SubscriptionsOut struct {
	Data   []SubscriptionRow `json:"data,omitempty"`
...
// SetData gets a reference to the given []SubscriptionRow and assigns it to the Data field.
...
func (o SubscriptionsOut) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionsOut) ToMap() (map[string]interface{}, error) {
...
type NullableSubscriptionsOut struct {
	value *SubscriptionsOut
	isSet bool
}

func (v NullableSubscriptionsOut) Get() *SubscriptionsOut {
	return v.value
}

func (v *NullableSubscriptionsOut) Set(val *SubscriptionsOut) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionsOut) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionsOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionsOut(val *SubscriptionsOut) *NullableSubscriptionsOut {
	return &NullableSubscriptionsOut{value: val, isSet: true}
}

func (v NullableSubscriptionsOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionsOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
