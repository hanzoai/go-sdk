...
type S3APIDeleteS3ByNameRequest struct {
	ctx        context.Context
	ApiService *S3APIService
	name       string
}

func (r S3APIDeleteS3ByNameRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteS3ByNameExecute(r)
}

/*
DeleteS3ByName Deletes one bucket from the shared object store and removes its metadata row.
...
metadata row. Answers 204 with no body; a second call is a 404.
	...
	@return S3APIDeleteS3ByNameRequest
*/
func (a *S3APIService) DeleteS3ByName(ctx context.Context, name string) S3APIDeleteS3ByNameRequest {
	return S3APIDeleteS3ByNameRequest{
		ApiService: a,
		ctx:        ctx,
		name:       name,
...
// Execute executes the request
func (a *S3APIService) DeleteS3ByNameExecute(r S3APIDeleteS3ByNameRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "S3APIService.DeleteS3ByName")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type S3APIGetS3Request struct {
	ctx        context.Context
	ApiService *S3APIService
}

func (r S3APIGetS3Request) Execute() ([]ProvisionedSummary, *http.Response, error) {
	return r.ApiService.GetS3Execute(r)
}

/*
GetS3 Lists the caller org's object-storage buckets.
...
distinct.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return S3APIGetS3Request
*/
func (a *S3APIService) GetS3(ctx context.Context) S3APIGetS3Request {
	return S3APIGetS3Request{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *S3APIService) GetS3Execute(r S3APIGetS3Request) ([]ProvisionedSummary, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "S3APIService.GetS3")
	if err != nil {
...
type S3APIGetS3ByNameRequest struct {
	ctx        context.Context
	ApiService *S3APIService
	name       string
}

func (r S3APIGetS3ByNameRequest) Execute() (*ProvisionedResource, *http.Response, error) {
	return r.ApiService.GetS3ByNameExecute(r)
}

/*
GetS3ByName Returns one bucket's metadata.
...
credential.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param name Name is the resource's org-unique slug, from the path. Lower-cased and trimmed before lookup, exactly as it was at create.
	@return S3APIGetS3ByNameRequest
*/
func (a *S3APIService) GetS3ByName(ctx context.Context, name string) S3APIGetS3ByNameRequest {
	return S3APIGetS3ByNameRequest{
		ApiService: a,
		ctx:        ctx,
		name:       name,
...
func (a *S3APIService) GetS3ByNameExecute(r S3APIGetS3ByNameRequest) (*ProvisionedResource, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "S3APIService.GetS3ByName")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type S3APIPostS3Request struct {
	ctx              context.Context
	ApiService       *S3APIService
	provisionRequest *ProvisionRequest
}

func (r S3APIPostS3Request) ProvisionRequest(provisionRequest ProvisionRequest) S3APIPostS3Request {
	r.provisionRequest = &provisionRequest
	return r
}

func (r S3APIPostS3Request) Execute() (*ProvisionResult, *http.Response, error) {
	return r.ApiService.PostS3Execute(r)
}

/*
PostS3 Provision an object storage bucket for your org
...
Billing is gated BEFORE anything is created: an unfunded org — or, in the fail-closed default, an unreachable meter — gets the fleet-wide 402/503 and nothing is provisioned. The fee is per-kind and set by the deployment.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return S3APIPostS3Request
*/
func (a *S3APIService) PostS3(ctx context.Context) S3APIPostS3Request {
	return S3APIPostS3Request{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *S3APIService) PostS3Execute(r S3APIPostS3Request) (*ProvisionResult, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "S3APIService.PostS3")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
