...
func TestBatchNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Batches.New(context.TODO(), hanzoai.BatchNewParams{
...
func TestBatchCancelWithProvider(t *testing.T) {
	...
	_, err := client.Batches.CancelWithProvider(
		context.TODO(),
		"provider",
		"batch_id",
	)
...
func TestBatchNewWithProvider(t *testing.T) {
	...
	_, err := client.Batches.NewWithProvider(context.TODO(), "provider")
	if err != nil {
		var apierr *hanzoai.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestBatchListWithProviderWithOptionalParams(t *testing.T) {
	...
	_, err := client.Batches.ListWithProvider(
		context.TODO(),
		"provider",
...
func TestBatchGetWithProvider(t *testing.T) {
	...
	_, err := client.Batches.GetWithProvider(
		context.TODO(),
		"provider",
		"batch_id",
	)
