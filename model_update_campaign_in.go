...
// checks if the UpdateCampaignIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpdateCampaignIn{}

// UpdateCampaignIn struct for UpdateCampaignIn
...
func (o UpdateCampaignIn) MarshalJSON() ([]byte, error) {
...
func (o UpdateCampaignIn) ToMap() (map[string]interface{}, error) {
...
type NullableUpdateCampaignIn struct {
	value *UpdateCampaignIn
	isSet bool
}

func (v NullableUpdateCampaignIn) Get() *UpdateCampaignIn {
	return v.value
}

func (v *NullableUpdateCampaignIn) Set(val *UpdateCampaignIn) {
	v.value = val
	v.isSet = true
}

func (v NullableUpdateCampaignIn) IsSet() bool {
	return v.isSet
}

func (v *NullableUpdateCampaignIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpdateCampaignIn(val *UpdateCampaignIn) *NullableUpdateCampaignIn {
	return &NullableUpdateCampaignIn{value: val, isSet: true}
}

func (v NullableUpdateCampaignIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpdateCampaignIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
