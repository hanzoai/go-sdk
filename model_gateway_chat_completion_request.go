...
type GatewayChatCompletionRequest struct {
	...
	ToolChoice       *GatewayChatCompletionRequestToolChoice `json:"tool_choice,omitempty"`
...
// SetToolChoice gets a reference to the given GatewayChatCompletionRequestToolChoice and assigns it to the ToolChoice field.
