...
// checks if the O11yO11yDomainGroupBy type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &O11yO11yDomainGroupBy{}

// O11yO11yDomainGroupBy struct for O11yO11yDomainGroupBy
type O11yO11yDomainGroupBy struct {
...
func (o O11yO11yDomainGroupBy) MarshalJSON() ([]byte, error) {
...
func (o O11yO11yDomainGroupBy) ToMap() (map[string]interface{}, error) {
...
type NullableO11yO11yDomainGroupBy struct {
	value *O11yO11yDomainGroupBy
	isSet bool
}

func (v NullableO11yO11yDomainGroupBy) Get() *O11yO11yDomainGroupBy {
	return v.value
}

func (v *NullableO11yO11yDomainGroupBy) Set(val *O11yO11yDomainGroupBy) {
	v.value = val
	v.isSet = true
}

func (v NullableO11yO11yDomainGroupBy) IsSet() bool {
	return v.isSet
}

func (v *NullableO11yO11yDomainGroupBy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableO11yO11yDomainGroupBy(val *O11yO11yDomainGroupBy) *NullableO11yO11yDomainGroupBy {
	return &NullableO11yO11yDomainGroupBy{value: val, isSet: true}
}

func (v NullableO11yO11yDomainGroupBy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableO11yO11yDomainGroupBy) UnmarshalJSON(src []byte) error {
	v.isSet = true
