...
// checks if the O11yO11yAttributeKey type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &O11yO11yAttributeKey{}

// O11yO11yAttributeKey struct for O11yO11yAttributeKey
type O11yO11yAttributeKey struct {
...
func (o O11yO11yAttributeKey) MarshalJSON() ([]byte, error) {
...
func (o O11yO11yAttributeKey) ToMap() (map[string]interface{}, error) {
...
type NullableO11yO11yAttributeKey struct {
	value *O11yO11yAttributeKey
	isSet bool
}

func (v NullableO11yO11yAttributeKey) Get() *O11yO11yAttributeKey {
	return v.value
}

func (v *NullableO11yO11yAttributeKey) Set(val *O11yO11yAttributeKey) {
	v.value = val
	v.isSet = true
}

func (v NullableO11yO11yAttributeKey) IsSet() bool {
	return v.isSet
}

func (v *NullableO11yO11yAttributeKey) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableO11yO11yAttributeKey(val *O11yO11yAttributeKey) *NullableO11yO11yAttributeKey {
	return &NullableO11yO11yAttributeKey{value: val, isSet: true}
}

func (v NullableO11yO11yAttributeKey) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableO11yO11yAttributeKey) UnmarshalJSON(src []byte) error {
	v.isSet = true
