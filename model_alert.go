...
type Alert struct {
	...
	PeriodSpentCents *int32  `json:"periodSpentCents,omitempty"`
...
// SetPeriodSpentCents gets a reference to the given int32 and assigns it to the PeriodSpentCents field.
