...
// checks if the O11yHostListRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &O11yHostListRequest{}
...
func (o O11yHostListRequest) MarshalJSON() ([]byte, error) {
...
func (o O11yHostListRequest) ToMap() (map[string]interface{}, error) {
...
type NullableO11yHostListRequest struct {
	value *O11yHostListRequest
	isSet bool
}

func (v NullableO11yHostListRequest) Get() *O11yHostListRequest {
	return v.value
}

func (v *NullableO11yHostListRequest) Set(val *O11yHostListRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableO11yHostListRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableO11yHostListRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableO11yHostListRequest(val *O11yHostListRequest) *NullableO11yHostListRequest {
	return &NullableO11yHostListRequest{value: val, isSet: true}
}

func (v NullableO11yHostListRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableO11yHostListRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
