...
// checks if the PostAiMemoryRemember200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostAiMemoryRemember200Response{}

// PostAiMemoryRemember200Response struct for PostAiMemoryRemember200Response
type PostAiMemoryRemember200Response struct {
...
type _PostAiMemoryRemember200Response PostAiMemoryRemember200Response
...
func NewPostAiMemoryRemember200Response(msg string, status string) *PostAiMemoryRemember200Response {
	this := PostAiMemoryRemember200Response{}
	this.Msg = msg
	this.Status = status
	return &this
}
...
func (o PostAiMemoryRemember200Response) MarshalJSON() ([]byte, error) {
...
func (o PostAiMemoryRemember200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PostAiMemoryRemember200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPostAiMemoryRemember200Response := _PostAiMemoryRemember200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostAiMemoryRemember200Response)

	if err != nil {
		return err
	}

	*o = PostAiMemoryRemember200Response(varPostAiMemoryRemember200Response)

	return err
}

type NullablePostAiMemoryRemember200Response struct {
	value *PostAiMemoryRemember200Response
	isSet bool
}

func (v NullablePostAiMemoryRemember200Response) Get() *PostAiMemoryRemember200Response {
	return v.value
}

func (v *NullablePostAiMemoryRemember200Response) Set(val *PostAiMemoryRemember200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePostAiMemoryRemember200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePostAiMemoryRemember200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostAiMemoryRemember200Response(val *PostAiMemoryRemember200Response) *NullablePostAiMemoryRemember200Response {
	return &NullablePostAiMemoryRemember200Response{value: val, isSet: true}
}

func (v NullablePostAiMemoryRemember200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostAiMemoryRemember200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
