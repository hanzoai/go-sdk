...
// checks if the PostAiFiles200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PostAiFiles200Response{}

// PostAiFiles200Response struct for PostAiFiles200Response
type PostAiFiles200Response struct {
...
type _PostAiFiles200Response PostAiFiles200Response
...
func (o PostAiFiles200Response) MarshalJSON() ([]byte, error) {
...
func (o PostAiFiles200Response) ToMap() (map[string]interface{}, error) {
...
func (o *PostAiFiles200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varPostAiFiles200Response := _PostAiFiles200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPostAiFiles200Response)

	if err != nil {
		return err
	}

	*o = PostAiFiles200Response(varPostAiFiles200Response)

	return err
}

type NullablePostAiFiles200Response struct {
	value *PostAiFiles200Response
	isSet bool
}

func (v NullablePostAiFiles200Response) Get() *PostAiFiles200Response {
	return v.value
}

func (v *NullablePostAiFiles200Response) Set(val *PostAiFiles200Response) {
	v.value = val
	v.isSet = true
}

func (v NullablePostAiFiles200Response) IsSet() bool {
	return v.isSet
}

func (v *NullablePostAiFiles200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePostAiFiles200Response(val *PostAiFiles200Response) *NullablePostAiFiles200Response {
	return &NullablePostAiFiles200Response{value: val, isSet: true}
}

func (v NullablePostAiFiles200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePostAiFiles200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
