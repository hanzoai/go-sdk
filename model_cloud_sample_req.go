...
// checks if the CloudSampleReq type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudSampleReq{}

// CloudSampleReq struct for CloudSampleReq
type CloudSampleReq struct {
...
func (o CloudSampleReq) MarshalJSON() ([]byte, error) {
...
func (o CloudSampleReq) ToMap() (map[string]interface{}, error) {
...
type NullableCloudSampleReq struct {
	value *CloudSampleReq
	isSet bool
}

func (v NullableCloudSampleReq) Get() *CloudSampleReq {
	return v.value
}

func (v *NullableCloudSampleReq) Set(val *CloudSampleReq) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudSampleReq) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudSampleReq) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudSampleReq(val *CloudSampleReq) *NullableCloudSampleReq {
	return &NullableCloudSampleReq{value: val, isSet: true}
}

func (v NullableCloudSampleReq) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudSampleReq) UnmarshalJSON(src []byte) error {
	v.isSet = true
