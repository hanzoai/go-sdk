...
// checks if the AgentsAgentDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AgentsAgentDetail{}

// AgentsAgentDetail struct for AgentsAgentDetail
type AgentsAgentDetail struct {
	...
	RecentRuns   []AgentsRunView `json:"recentRuns,omitempty"`
}
...
// SetRecentRuns gets a reference to the given []AgentsRunView and assigns it to the RecentRuns field.
func (o *AgentsAgentDetail) SetRecentRuns(v []AgentsRunView) {
	o.RecentRuns = v
}

func (o AgentsAgentDetail) MarshalJSON() ([]byte, error) {
...
func (o AgentsAgentDetail) ToMap() (map[string]interface{}, error) {
...
type NullableAgentsAgentDetail struct {
	value *AgentsAgentDetail
	isSet bool
}

func (v NullableAgentsAgentDetail) Get() *AgentsAgentDetail {
	return v.value
}

func (v *NullableAgentsAgentDetail) Set(val *AgentsAgentDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableAgentsAgentDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableAgentsAgentDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAgentsAgentDetail(val *AgentsAgentDetail) *NullableAgentsAgentDetail {
	return &NullableAgentsAgentDetail{value: val, isSet: true}
}

func (v NullableAgentsAgentDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAgentsAgentDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
