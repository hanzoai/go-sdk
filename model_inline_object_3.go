...
func (o *InlineObject3) GetError() string {
...
func (o *InlineObject3) GetErrorOk() (*string, bool) {
	if o == nil || IsNil(o.Error) {
		return nil, false
	}
	return o.Error, true
...
func (o *InlineObject3) HasError() bool {
	if o != nil && !IsNil(o.Error) {
		return true
	}
...
func (o *InlineObject3) SetError(v string) {
	o.Error = &v
}
