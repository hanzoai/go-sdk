...
func (o *InlineObject1) GetStatus() int32 {
...
func (o *InlineObject1) GetStatusOk() (*int32, bool) {
	if o == nil || IsNil(o.Status) {
		return nil, false
	}
...
func (o *InlineObject1) HasStatus() bool {
	if o != nil && !IsNil(o.Status) {
		return true
	}
...
func (o *InlineObject1) SetStatus(v int32) {
	o.Status = &v
}
