...
// checks if the CloudCreateEndpointIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCreateEndpointIn{}

// CloudCreateEndpointIn struct for CloudCreateEndpointIn
type CloudCreateEndpointIn struct {
...
func (o CloudCreateEndpointIn) MarshalJSON() ([]byte, error) {
...
func (o CloudCreateEndpointIn) ToMap() (map[string]interface{}, error) {
...
type NullableCloudCreateEndpointIn struct {
	value *CloudCreateEndpointIn
	isSet bool
}

func (v NullableCloudCreateEndpointIn) Get() *CloudCreateEndpointIn {
	return v.value
}

func (v *NullableCloudCreateEndpointIn) Set(val *CloudCreateEndpointIn) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCreateEndpointIn) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCreateEndpointIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCreateEndpointIn(val *CloudCreateEndpointIn) *NullableCloudCreateEndpointIn {
	return &NullableCloudCreateEndpointIn{value: val, isSet: true}
}

func (v NullableCloudCreateEndpointIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCreateEndpointIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
