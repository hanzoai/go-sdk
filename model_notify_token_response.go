...
// checks if the NotifyTokenResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NotifyTokenResponse{}

// NotifyTokenResponse struct for NotifyTokenResponse
...
func (o NotifyTokenResponse) MarshalJSON() ([]byte, error) {
...
func (o NotifyTokenResponse) ToMap() (map[string]interface{}, error) {
...
type NullableNotifyTokenResponse struct {
	value *NotifyTokenResponse
	isSet bool
}

func (v NullableNotifyTokenResponse) Get() *NotifyTokenResponse {
	return v.value
}

func (v *NullableNotifyTokenResponse) Set(val *NotifyTokenResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableNotifyTokenResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableNotifyTokenResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNotifyTokenResponse(val *NotifyTokenResponse) *NullableNotifyTokenResponse {
	return &NullableNotifyTokenResponse{value: val, isSet: true}
}

func (v NullableNotifyTokenResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNotifyTokenResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
