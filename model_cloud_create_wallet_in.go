...
// checks if the CloudCreateWalletIn type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCreateWalletIn{}

// CloudCreateWalletIn struct for CloudCreateWalletIn
type CloudCreateWalletIn struct {
...
func (o CloudCreateWalletIn) MarshalJSON() ([]byte, error) {
...
func (o CloudCreateWalletIn) ToMap() (map[string]interface{}, error) {
...
type NullableCloudCreateWalletIn struct {
	value *CloudCreateWalletIn
	isSet bool
}

func (v NullableCloudCreateWalletIn) Get() *CloudCreateWalletIn {
	return v.value
}

func (v *NullableCloudCreateWalletIn) Set(val *CloudCreateWalletIn) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCreateWalletIn) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCreateWalletIn) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCreateWalletIn(val *CloudCreateWalletIn) *NullableCloudCreateWalletIn {
	return &NullableCloudCreateWalletIn{value: val, isSet: true}
}

func (v NullableCloudCreateWalletIn) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCreateWalletIn) UnmarshalJSON(src []byte) error {
	v.isSet = true
