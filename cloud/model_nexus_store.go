...
// checks if the NexusStore type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NexusStore{}

// NexusStore struct for NexusStore
type NexusStore struct {
	...
	FileTree *NexusFile `json:"fileTree,omitempty"`
	...
	Prompts []NexusPrompt `json:"prompts,omitempty"`
...
// SetFileTree gets a reference to the given NexusFile and assigns it to the FileTree field.
...
// SetPrompts gets a reference to the given []NexusPrompt and assigns it to the Prompts field.
...
func (o NexusStore) MarshalJSON() ([]byte, error) {
...
func (o NexusStore) ToMap() (map[string]interface{}, error) {
...
type NullableNexusStore struct {
	value *NexusStore
	isSet bool
}

func (v NullableNexusStore) Get() *NexusStore {
	return v.value
}

func (v *NullableNexusStore) Set(val *NexusStore) {
	v.value = val
	v.isSet = true
}

func (v NullableNexusStore) IsSet() bool {
	return v.isSet
}

func (v *NullableNexusStore) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNexusStore(val *NexusStore) *NullableNexusStore {
	return &NullableNexusStore{value: val, isSet: true}
}

func (v NullableNexusStore) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNexusStore) UnmarshalJSON(src []byte) error {
	v.isSet = true
