...
// checks if the FlowFlowRun type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlowFlowRun{}

// FlowFlowRun struct for FlowFlowRun
type FlowFlowRun struct {
...
func (o FlowFlowRun) MarshalJSON() ([]byte, error) {
...
func (o FlowFlowRun) ToMap() (map[string]interface{}, error) {
...
type NullableFlowFlowRun struct {
	value *FlowFlowRun
	isSet bool
}

func (v NullableFlowFlowRun) Get() *FlowFlowRun {
	return v.value
}

func (v *NullableFlowFlowRun) Set(val *FlowFlowRun) {
	v.value = val
	v.isSet = true
}

func (v NullableFlowFlowRun) IsSet() bool {
	return v.isSet
}

func (v *NullableFlowFlowRun) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlowFlowRun(val *FlowFlowRun) *NullableFlowFlowRun {
	return &NullableFlowFlowRun{value: val, isSet: true}
}

func (v NullableFlowFlowRun) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlowFlowRun) UnmarshalJSON(src []byte) error {
	v.isSet = true
