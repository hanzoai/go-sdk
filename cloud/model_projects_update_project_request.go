...
func (o *ProjectsUpdateProjectRequest) GetRepo() ProjectsCreateProjectRequestRepo {
...
// and a boolean to check if the value has been set.
func (o *ProjectsUpdateProjectRequest) GetRepoOk() (*ProjectsCreateProjectRequestRepo, bool) {
	if o == nil || IsNil(o.Repo) {
		return nil, false
	}
	return o.Repo, true
...
func (o *ProjectsUpdateProjectRequest) SetRepo(v ProjectsCreateProjectRequestRepo) {
	o.Repo = &v
}
