...
// checks if the FlowAppConnection type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FlowAppConnection{}

// FlowAppConnection struct for FlowAppConnection
type FlowAppConnection struct {
...
func (o FlowAppConnection) MarshalJSON() ([]byte, error) {
...
func (o FlowAppConnection) ToMap() (map[string]interface{}, error) {
...
type NullableFlowAppConnection struct {
	value *FlowAppConnection
	isSet bool
}

func (v NullableFlowAppConnection) Get() *FlowAppConnection {
	return v.value
}

func (v *NullableFlowAppConnection) Set(val *FlowAppConnection) {
	v.value = val
	v.isSet = true
}

func (v NullableFlowAppConnection) IsSet() bool {
	return v.isSet
}

func (v *NullableFlowAppConnection) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFlowAppConnection(val *FlowAppConnection) *NullableFlowAppConnection {
	return &NullableFlowAppConnection{value: val, isSet: true}
}

func (v NullableFlowAppConnection) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFlowAppConnection) UnmarshalJSON(src []byte) error {
	v.isSet = true
