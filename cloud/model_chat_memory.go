...
// checks if the ChatMemory type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ChatMemory{}

// ChatMemory struct for ChatMemory
...
func (o ChatMemory) MarshalJSON() ([]byte, error) {
...
func (o ChatMemory) ToMap() (map[string]interface{}, error) {
...
type NullableChatMemory struct {
	value *ChatMemory
	isSet bool
}

func (v NullableChatMemory) Get() *ChatMemory {
	return v.value
}

func (v *NullableChatMemory) Set(val *ChatMemory) {
	v.value = val
	v.isSet = true
}

func (v NullableChatMemory) IsSet() bool {
	return v.isSet
}

func (v *NullableChatMemory) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableChatMemory(val *ChatMemory) *NullableChatMemory {
	return &NullableChatMemory{value: val, isSet: true}
}

func (v NullableChatMemory) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableChatMemory) UnmarshalJSON(src []byte) error {
	v.isSet = true
