...
// checks if the ConsoleTrace type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ConsoleTrace{}

// ConsoleTrace struct for ConsoleTrace
...
func (o ConsoleTrace) MarshalJSON() ([]byte, error) {
...
func (o ConsoleTrace) ToMap() (map[string]interface{}, error) {
...
type NullableConsoleTrace struct {
	value *ConsoleTrace
	isSet bool
}

func (v NullableConsoleTrace) Get() *ConsoleTrace {
	return v.value
}

func (v *NullableConsoleTrace) Set(val *ConsoleTrace) {
	v.value = val
	v.isSet = true
}

func (v NullableConsoleTrace) IsSet() bool {
	return v.isSet
}

func (v *NullableConsoleTrace) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableConsoleTrace(val *ConsoleTrace) *NullableConsoleTrace {
	return &NullableConsoleTrace{value: val, isSet: true}
}

func (v NullableConsoleTrace) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableConsoleTrace) UnmarshalJSON(src []byte) error {
	v.isSet = true
