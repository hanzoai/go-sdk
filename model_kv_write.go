...
// checks if the KvWrite type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KvWrite{}

// KvWrite struct for KvWrite
type KvWrite struct {
...
func (o KvWrite) MarshalJSON() ([]byte, error) {
...
func (o KvWrite) ToMap() (map[string]interface{}, error) {
...
type NullableKvWrite struct {
	value *KvWrite
	isSet bool
}

func (v NullableKvWrite) Get() *KvWrite {
	return v.value
}

func (v *NullableKvWrite) Set(val *KvWrite) {
	v.value = val
	v.isSet = true
}

func (v NullableKvWrite) IsSet() bool {
	return v.isSet
}

func (v *NullableKvWrite) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKvWrite(val *KvWrite) *NullableKvWrite {
	return &NullableKvWrite{value: val, isSet: true}
}

func (v NullableKvWrite) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKvWrite) UnmarshalJSON(src []byte) error {
	v.isSet = true
