...
type LinksAPIDeleteLinksByIdRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
	id         string
}

func (r LinksAPIDeleteLinksByIdRequest) Execute() (*RevokeResp, *http.Response, error) {
	return r.ApiService.DeleteLinksByIdExecute(r)
}

/*
DeleteLinksById Logs out one account and stops the sessions it was running.
...
belongs to another user or org, is the same 404.
	...
	@return LinksAPIDeleteLinksByIdRequest
*/
func (a *LinksAPIService) DeleteLinksById(ctx context.Context, id string) LinksAPIDeleteLinksByIdRequest {
	return LinksAPIDeleteLinksByIdRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return RevokeResp
func (a *LinksAPIService) DeleteLinksByIdExecute(r LinksAPIDeleteLinksByIdRequest) (*RevokeResp, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.DeleteLinksById")
	if err != nil {
...
func (r LinksAPIGetLinksRequest) Execute() (*LinkList, *http.Response, error) {
	return r.ApiService.GetLinksExecute(r)
}

/*
GetLinks Lists your linked accounts and the devices they sit on.
...
//
//	@return LinkList
func (a *LinksAPIService) GetLinksExecute(r LinksAPIGetLinksRequest) (*LinkList, *http.Response, error) {
	var (
...
type LinksAPIGetLinksByIdRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
	id         string
}

func (r LinksAPIGetLinksByIdRequest) Execute() (*LinkView, *http.Response, error) {
	return r.ApiService.GetLinksByIdExecute(r)
}

/*
GetLinksById Reads one linked account.
...
addressed here.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id ID is the link to act on, from the path. It is scoped to the caller, so another user's or org's id is a 404.
	@return LinksAPIGetLinksByIdRequest
*/
func (a *LinksAPIService) GetLinksById(ctx context.Context, id string) LinksAPIGetLinksByIdRequest {
	return LinksAPIGetLinksByIdRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return LinkView
func (a *LinksAPIService) GetLinksByIdExecute(r LinksAPIGetLinksByIdRequest) (*LinkView, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.GetLinksById")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type LinksAPIGetLinksDevicesByMachineRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
	machine    string
}

func (r LinksAPIGetLinksDevicesByMachineRequest) Execute() (*DeviceView, *http.Response, error) {
	return r.ApiService.GetLinksDevicesByMachineExecute(r)
}

/*
GetLinksDevicesByMachine Shows one machine: its accounts, usage and live sessions.
...
where the agent plane is not mounted rather than failing the read.
	...
	@return LinksAPIGetLinksDevicesByMachineRequest
*/
func (a *LinksAPIService) GetLinksDevicesByMachine(ctx context.Context, machine string) LinksAPIGetLinksDevicesByMachineRequest {
	return LinksAPIGetLinksDevicesByMachineRequest{
		ApiService: a,
		ctx:        ctx,
		machine:    machine,
...
//
//	@return DeviceView
func (a *LinksAPIService) GetLinksDevicesByMachineExecute(r LinksAPIGetLinksDevicesByMachineRequest) (*DeviceView, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.GetLinksDevicesByMachine")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type LinksAPIGetLinksRouteRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
}

func (r LinksAPIGetLinksRouteRequest) Execute() (*RoutePlan, *http.Response, error) {
	return r.ApiService.GetLinksRouteExecute(r)
}

/*
GetLinksRoute Gets the failover order across your linked accounts.
...
caller. A link with no snapshot counts as full headroom.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return LinksAPIGetLinksRouteRequest
*/
func (a *LinksAPIService) GetLinksRoute(ctx context.Context) LinksAPIGetLinksRouteRequest {
	return LinksAPIGetLinksRouteRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return RoutePlan
func (a *LinksAPIService) GetLinksRouteExecute(r LinksAPIGetLinksRouteRequest) (*RoutePlan, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.GetLinksRoute")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type LinksAPIGetLinksUsageRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
	provider   *string
	account    *string
...
func (r LinksAPIGetLinksUsageRequest) Provider(provider string) LinksAPIGetLinksUsageRequest {
	r.provider = &provider
	return r
}

// Account narrows to one account when a user has several with the provider.
func (r LinksAPIGetLinksUsageRequest) Account(account string) LinksAPIGetLinksUsageRequest {
	r.account = &account
	return r
}

// Window selects a window class: 6h, day, week or month. Empty reads all.
func (r LinksAPIGetLinksUsageRequest) Window(window string) LinksAPIGetLinksUsageRequest {
	r.window = &window
	return r
}

// Range is the period, one of 1h, 24h, 7d or 30d; empty means 24h, and an unknown label is 400, never a quiet fallback.
func (r LinksAPIGetLinksUsageRequest) Range_(range_ string) LinksAPIGetLinksUsageRequest {
	r.range_ = &range_
	return r
}

func (r LinksAPIGetLinksUsageRequest) Execute() (*BoardResp, *http.Response, error) {
	return r.ApiService.GetLinksUsageExecute(r)
}

/*
GetLinksUsage Shows one provider account's own usage dashboard.
...
honest "we have no data", which is a different claim from zero usage.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return LinksAPIGetLinksUsageRequest
*/
func (a *LinksAPIService) GetLinksUsage(ctx context.Context) LinksAPIGetLinksUsageRequest {
	return LinksAPIGetLinksUsageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return BoardResp
func (a *LinksAPIService) GetLinksUsageExecute(r LinksAPIGetLinksUsageRequest) (*BoardResp, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.GetLinksUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type LinksAPIGetLinksUsageAccountsRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
}

func (r LinksAPIGetLinksUsageAccountsRequest) Execute() (*AccountsUsage, *http.Response, error) {
	return r.ApiService.GetLinksUsageAccountsExecute(r)
}

/*
GetLinksUsageAccounts Breaks down what the gateway routed through each of your accounts.
...
namespace, from one shaping function, so the two mounts cannot drift.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return LinksAPIGetLinksUsageAccountsRequest
*/
func (a *LinksAPIService) GetLinksUsageAccounts(ctx context.Context) LinksAPIGetLinksUsageAccountsRequest {
	return LinksAPIGetLinksUsageAccountsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *LinksAPIService) GetLinksUsageAccountsExecute(r LinksAPIGetLinksUsageAccountsRequest) (*AccountsUsage, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.GetLinksUsageAccounts")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type LinksAPIGetLinksUsageSummaryRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
	range_     *string
}
...
func (r LinksAPIGetLinksUsageSummaryRequest) Range_(range_ string) LinksAPIGetLinksUsageSummaryRequest {
	r.range_ = &range_
	return r
}

func (r LinksAPIGetLinksUsageSummaryRequest) Execute() (*SummaryResp, *http.Response, error) {
	return r.ApiService.GetLinksUsageSummaryExecute(r)
}

/*
GetLinksUsageSummary Shows plan consumption and Hanzo spend side by side.
...
answer reports available:false instead of a zero that would read as "no usage".
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return LinksAPIGetLinksUsageSummaryRequest
*/
func (a *LinksAPIService) GetLinksUsageSummary(ctx context.Context) LinksAPIGetLinksUsageSummaryRequest {
	return LinksAPIGetLinksUsageSummaryRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return SummaryResp
func (a *LinksAPIService) GetLinksUsageSummaryExecute(r LinksAPIGetLinksUsageSummaryRequest) (*SummaryResp, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.GetLinksUsageSummary")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r LinksAPIPostLinksRequest) EnrollReq(enrollReq EnrollReq) LinksAPIPostLinksRequest {
	r.enrollReq = &enrollReq
	return r
}

func (r LinksAPIPostLinksRequest) Execute() (*LinkView, *http.Response, error) {
	return r.ApiService.PostLinksExecute(r)
}

/*
PostLinks Registers a signed-in AI provider account on a machine.
...
//
//	@return LinkView
func (a *LinksAPIService) PostLinksExecute(r LinksAPIPostLinksRequest) (*LinkView, *http.Response, error) {
	var (
...
type LinksAPIPostLinksDevicesByMachineRevokeRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
	machine    string
}

func (r LinksAPIPostLinksDevicesByMachineRevokeRequest) Execute() (*RevokeResp, *http.Response, error) {
	return r.ApiService.PostLinksDevicesByMachineRevokeExecute(r)
}

/*
PostLinksDevicesByMachineRevoke Logs out every account on one machine and stops its sessions.
...
with nothing left to revoke is 404.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param machine Machine is the machine to act on, from the path. It is scoped to the caller, so a machine with none of the caller's accounts is a 404.
	@return LinksAPIPostLinksDevicesByMachineRevokeRequest
*/
func (a *LinksAPIService) PostLinksDevicesByMachineRevoke(ctx context.Context, machine string) LinksAPIPostLinksDevicesByMachineRevokeRequest {
	return LinksAPIPostLinksDevicesByMachineRevokeRequest{
		ApiService: a,
		ctx:        ctx,
		machine:    machine,
...
//
//	@return RevokeResp
func (a *LinksAPIService) PostLinksDevicesByMachineRevokeExecute(r LinksAPIPostLinksDevicesByMachineRevokeRequest) (*RevokeResp, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.PostLinksDevicesByMachineRevoke")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type LinksAPIPostLinksUsageRequest struct {
	ctx        context.Context
	ApiService *LinksAPIService
	ingestReq  *IngestReq
}

func (r LinksAPIPostLinksUsageRequest) IngestReq(ingestReq IngestReq) LinksAPIPostLinksUsageRequest {
	r.ingestReq = &ingestReq
	return r
}

func (r LinksAPIPostLinksUsageRequest) Execute() (*IngestResp, *http.Response, error) {
	return r.ApiService.PostLinksUsageExecute(r)
}

/*
PostLinksUsage Reports usage samples from the device collector.
...
reclassified sample would fill a dashboard with a class nobody reported.
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return LinksAPIPostLinksUsageRequest
*/
func (a *LinksAPIService) PostLinksUsage(ctx context.Context) LinksAPIPostLinksUsageRequest {
	return LinksAPIPostLinksUsageRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return IngestResp
func (a *LinksAPIService) PostLinksUsageExecute(r LinksAPIPostLinksUsageRequest) (*IngestResp, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LinksAPIService.PostLinksUsage")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
