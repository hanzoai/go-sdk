...
func TestOrganizationInfoGet(t *testing.T) {
	...
	_, err := client.Organization.Info.Get(context.TODO(), hanzoai.OrganizationInfoGetParams{
...
func TestOrganizationInfoDeprecated(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Organization.Info.Deprecated(context.TODO(), hanzoai.OrganizationInfoDeprecatedParams{
