...
type VectorScoredPoint struct {
	Id      *VectorDeletePointsRequestPointsInner `json:"id,omitempty"`
	Version *int32                                `json:"version,omitempty"`
	Score   *float32                              `json:"score,omitempty"`
	Payload map[string]interface{}                `json:"payload,omitempty"`
	Vector  *VectorScoredPointVector              `json:"vector,omitempty"`
}
...
// SetId gets a reference to the given VectorDeletePointsRequestPointsInner and assigns it to the Id field.
...
func (o *VectorScoredPoint) GetVector() VectorScoredPointVector {
	if o == nil || IsNil(o.Vector) {
		var ret VectorScoredPointVector
		return ret
	}
	return *o.Vector
}
...
// SetVector gets a reference to the given VectorScoredPointVector and assigns it to the Vector field.
