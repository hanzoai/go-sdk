...
// checks if the AiChatMessage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AiChatMessage{}
...
type _AiChatMessage AiChatMessage
...
func (o AiChatMessage) ToMap() (map[string]interface{}, error) {
...
func (o *AiChatMessage) UnmarshalJSON(data []byte) (err error) {
	...
	varAiChatMessage := _AiChatMessage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAiChatMessage)

	if err != nil {
		return err
	}

	*o = AiChatMessage(varAiChatMessage)
