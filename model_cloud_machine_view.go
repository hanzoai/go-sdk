...
// checks if the CloudMachineView type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudMachineView{}

// CloudMachineView struct for CloudMachineView
type CloudMachineView struct {
...
func (o CloudMachineView) MarshalJSON() ([]byte, error) {
...
func (o CloudMachineView) ToMap() (map[string]interface{}, error) {
...
type NullableCloudMachineView struct {
	value *CloudMachineView
	isSet bool
}

func (v NullableCloudMachineView) Get() *CloudMachineView {
	return v.value
}

func (v *NullableCloudMachineView) Set(val *CloudMachineView) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudMachineView) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudMachineView) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudMachineView(val *CloudMachineView) *NullableCloudMachineView {
	return &NullableCloudMachineView{value: val, isSet: true}
}

func (v NullableCloudMachineView) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudMachineView) UnmarshalJSON(src []byte) error {
	v.isSet = true
