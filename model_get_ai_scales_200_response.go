...
// checks if the GetAiScales200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetAiScales200Response{}

// GetAiScales200Response struct for GetAiScales200Response
type GetAiScales200Response struct {
...
type _GetAiScales200Response GetAiScales200Response
...
func (o GetAiScales200Response) MarshalJSON() ([]byte, error) {
...
func (o GetAiScales200Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetAiScales200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetAiScales200Response := _GetAiScales200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetAiScales200Response)

	if err != nil {
		return err
	}

	*o = GetAiScales200Response(varGetAiScales200Response)

	return err
}

type NullableGetAiScales200Response struct {
	value *GetAiScales200Response
	isSet bool
}

func (v NullableGetAiScales200Response) Get() *GetAiScales200Response {
	return v.value
}

func (v *NullableGetAiScales200Response) Set(val *GetAiScales200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetAiScales200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetAiScales200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetAiScales200Response(val *GetAiScales200Response) *NullableGetAiScales200Response {
	return &NullableGetAiScales200Response{value: val, isSet: true}
}

func (v NullableGetAiScales200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetAiScales200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
