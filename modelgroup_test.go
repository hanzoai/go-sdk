...
func TestModelGroupGetInfoWithOptionalParams(t *testing.T) {
	...
	_, err := client.ModelGroup.GetInfo(context.TODO(), hanzoai.ModelGroupGetInfoParams{
		ModelGroup: hanzoai.F("model_group"),
	})
	if err != nil {
