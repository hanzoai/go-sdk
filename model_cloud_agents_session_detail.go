...
// checks if the CloudAgentsSessionDetail type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudAgentsSessionDetail{}

// CloudAgentsSessionDetail struct for CloudAgentsSessionDetail
type CloudAgentsSessionDetail struct {
	// Session id (sess_...).
	...
	ChildSessions []CloudAgentsSession `json:"childSessions,omitempty"`
	RecentEvents  []CloudAgentsEvent   `json:"recentEvents,omitempty"`
}
...
// SetChildSessions gets a reference to the given []CloudAgentsSession and assigns it to the ChildSessions field.
...
// SetRecentEvents gets a reference to the given []CloudAgentsEvent and assigns it to the RecentEvents field.
func (o *CloudAgentsSessionDetail) SetRecentEvents(v []CloudAgentsEvent) {
	o.RecentEvents = v
}

func (o CloudAgentsSessionDetail) MarshalJSON() ([]byte, error) {
...
func (o CloudAgentsSessionDetail) ToMap() (map[string]interface{}, error) {
...
type NullableCloudAgentsSessionDetail struct {
	value *CloudAgentsSessionDetail
	isSet bool
}

func (v NullableCloudAgentsSessionDetail) Get() *CloudAgentsSessionDetail {
	return v.value
}

func (v *NullableCloudAgentsSessionDetail) Set(val *CloudAgentsSessionDetail) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudAgentsSessionDetail) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudAgentsSessionDetail) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudAgentsSessionDetail(val *CloudAgentsSessionDetail) *NullableCloudAgentsSessionDetail {
	return &NullableCloudAgentsSessionDetail{value: val, isSet: true}
}

func (v NullableCloudAgentsSessionDetail) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudAgentsSessionDetail) UnmarshalJSON(src []byte) error {
	v.isSet = true
