...
func (r PipelinesAPIGetPipelinesRequest) Execute() (*PipelineBoard, *http.Response, error) {
	return r.ApiService.GetPipelinesExecute(r)
}

/*
GetPipelines Returns one build-and-deploy pipeline per app, with its latest run.
...
func (a *PipelinesAPIService) GetPipelinesExecute(r PipelinesAPIGetPipelinesRequest) (*PipelineBoard, *http.Response, error) {
	var (
