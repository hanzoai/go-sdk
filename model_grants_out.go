...
// checks if the GrantsOut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GrantsOut{}

// GrantsOut struct for GrantsOut
type GrantsOut struct {
	Data   []GrantRow `json:"data,omitempty"`
...
// SetData gets a reference to the given []GrantRow and assigns it to the Data field.
...
func (o GrantsOut) MarshalJSON() ([]byte, error) {
...
func (o GrantsOut) ToMap() (map[string]interface{}, error) {
...
type NullableGrantsOut struct {
	value *GrantsOut
	isSet bool
}

func (v NullableGrantsOut) Get() *GrantsOut {
	return v.value
}

func (v *NullableGrantsOut) Set(val *GrantsOut) {
	v.value = val
	v.isSet = true
}

func (v NullableGrantsOut) IsSet() bool {
	return v.isSet
}

func (v *NullableGrantsOut) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGrantsOut(val *GrantsOut) *NullableGrantsOut {
	return &NullableGrantsOut{value: val, isSet: true}
}

func (v NullableGrantsOut) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGrantsOut) UnmarshalJSON(src []byte) error {
	v.isSet = true
