...
// checks if the CloudFlow type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudFlow{}

// CloudFlow struct for CloudFlow
...
func (o CloudFlow) MarshalJSON() ([]byte, error) {
...
func (o CloudFlow) ToMap() (map[string]interface{}, error) {
...
type NullableCloudFlow struct {
	value *CloudFlow
	isSet bool
}

func (v NullableCloudFlow) Get() *CloudFlow {
	return v.value
}

func (v *NullableCloudFlow) Set(val *CloudFlow) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudFlow) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudFlow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudFlow(val *CloudFlow) *NullableCloudFlow {
	return &NullableCloudFlow{value: val, isSet: true}
}

func (v NullableCloudFlow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudFlow) UnmarshalJSON(src []byte) error {
	v.isSet = true
