...
------------ | ------------- | ------------- | -------------
**Added** | Pointer to **int64** | Added is how many listings the catalog did not have before. | [optional] 
**Registry** | Pointer to **string** | Registry is the upstream this pass read. | [optional] 
**Total** | Pointer to **int64** | Total is how many listings the catalog holds now. | [optional] 
**Updated** | Pointer to **int64** | Updated is how many the publisher has changed since we last looked. | [optional] 
