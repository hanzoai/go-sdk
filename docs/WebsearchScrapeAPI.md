...
------------- | ------------- | -------------
[**WebsearchWebScrape**](WebsearchScrapeAPI.md#WebsearchWebScrape) | **Post** /v1/websearch/v1/scrape | Scrape a URL to markdown (Firecrawl response shape)
[**WebsearchWebScrapeBare**](WebsearchScrapeAPI.md#WebsearchWebScrapeBare) | **Post** /v1/websearch/scrape | Scrape a URL to markdown (bare alias of /v1/websearch/v1/scrape)
...
func main() {
	...
	resp, r, err := apiClient.WebsearchScrapeAPI.WebsearchWebScrape(context.Background()).WebsearchScrapeRequest(websearchScrapeRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WebsearchScrapeAPI.WebsearchWebScrape``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `WebsearchWebScrape`: WebsearchScrapeResponse
	fmt.Fprintf(os.Stdout, "Response from `WebsearchScrapeAPI.WebsearchWebScrape`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.WebsearchScrapeAPI.WebsearchWebScrapeBare(context.Background()).WebsearchScrapeRequest(websearchScrapeRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `WebsearchScrapeAPI.WebsearchWebScrapeBare``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `WebsearchWebScrapeBare`: WebsearchScrapeResponse
	fmt.Fprintf(os.Stdout, "Response from `WebsearchScrapeAPI.WebsearchWebScrapeBare`: %v\n", resp)
}
```
