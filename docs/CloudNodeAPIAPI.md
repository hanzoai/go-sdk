...
------------- | ------------- | -------------
[**CloudApiControllerAddNode**](CloudNodeAPIAPI.md#CloudApiControllerAddNode) | **Post** /v1/cloud/add-node | Api Controller Add Node
[**CloudApiControllerDeleteNode**](CloudNodeAPIAPI.md#CloudApiControllerDeleteNode) | **Post** /v1/cloud/delete-node | Api Controller Delete Node
[**CloudApiControllerGetNode**](CloudNodeAPIAPI.md#CloudApiControllerGetNode) | **Get** /v1/cloud/get-node | Api Controller Get Node
[**CloudApiControllerGetNodes**](CloudNodeAPIAPI.md#CloudApiControllerGetNodes) | **Get** /v1/cloud/get-nodes | Api Controller Get Nodes
[**CloudApiControllerUpdateNode**](CloudNodeAPIAPI.md#CloudApiControllerUpdateNode) | **Post** /v1/cloud/update-node | Api Controller Update Node
...
func main() {
	...
	resp, r, err := apiClient.CloudNodeAPIAPI.CloudApiControllerAddNode(context.Background()).CloudObjectNode(cloudObjectNode).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudNodeAPIAPI.CloudApiControllerAddNode``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudApiControllerAddNode`: CloudControllersResponse
	fmt.Fprintf(os.Stdout, "Response from `CloudNodeAPIAPI.CloudApiControllerAddNode`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudNodeAPIAPI.CloudApiControllerDeleteNode(context.Background()).CloudObjectNode(cloudObjectNode).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudNodeAPIAPI.CloudApiControllerDeleteNode``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudApiControllerDeleteNode`: CloudControllersResponse
	fmt.Fprintf(os.Stdout, "Response from `CloudNodeAPIAPI.CloudApiControllerDeleteNode`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudNodeAPIAPI.CloudApiControllerGetNode(context.Background()).Id(id).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudNodeAPIAPI.CloudApiControllerGetNode``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudApiControllerGetNode`: CloudObjectNode
	fmt.Fprintf(os.Stdout, "Response from `CloudNodeAPIAPI.CloudApiControllerGetNode`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudNodeAPIAPI.CloudApiControllerGetNodes(context.Background()).PageSize(pageSize).P(p).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudNodeAPIAPI.CloudApiControllerGetNodes``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudApiControllerGetNodes`: CloudObjectNode
	fmt.Fprintf(os.Stdout, "Response from `CloudNodeAPIAPI.CloudApiControllerGetNodes`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CloudNodeAPIAPI.CloudApiControllerUpdateNode(context.Background()).Id(id).CloudObjectNode(cloudObjectNode).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CloudNodeAPIAPI.CloudApiControllerUpdateNode``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CloudApiControllerUpdateNode`: CloudControllersResponse
	fmt.Fprintf(os.Stdout, "Response from `CloudNodeAPIAPI.CloudApiControllerUpdateNode`: %v\n", resp)
}
```
