...
------------ | ------------- | ------------- | -------------
**Points** | Pointer to [**[]VectorPointId**](VectorPointId.md) |  | [optional] 
...
`func (o *VectorDeletePointsRequest) GetPoints() []VectorPointId`

GetPoints returns the Points field if non-nil, zero value otherwise.

### GetPointsOk

`func (o *VectorDeletePointsRequest) GetPointsOk() (*[]VectorPointId, bool)`
...
`func (o *VectorDeletePointsRequest) SetPoints(v []VectorPointId)`
