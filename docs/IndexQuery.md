...
**Limit** | Pointer to **int32** | Limit is how many hits to return. Absent means 20; the ceiling is 1000. | [optional] 
**Offset** | Pointer to **int32** | Offset is where to start. Absent means 0. | [optional] 
