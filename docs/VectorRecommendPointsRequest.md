...
------------ | ------------- | ------------- | -------------
**Positive** | [**[]VectorDeletePointsRequestPointsInner**](VectorDeletePointsRequestPointsInner.md) |  | 
**Negative** | Pointer to [**[]VectorDeletePointsRequestPointsInner**](VectorDeletePointsRequestPointsInner.md) |  | [optional] 
...
`func NewVectorRecommendPointsRequest(positive []VectorDeletePointsRequestPointsInner, ) *VectorRecommendPointsRequest`
...
`func (o *VectorRecommendPointsRequest) GetPositive() []VectorDeletePointsRequestPointsInner`

GetPositive returns the Positive field if non-nil, zero value otherwise.

### GetPositiveOk

`func (o *VectorRecommendPointsRequest) GetPositiveOk() (*[]VectorDeletePointsRequestPointsInner, bool)`
...
`func (o *VectorRecommendPointsRequest) SetPositive(v []VectorDeletePointsRequestPointsInner)`
...
`func (o *VectorRecommendPointsRequest) GetNegative() []VectorDeletePointsRequestPointsInner`

GetNegative returns the Negative field if non-nil, zero value otherwise.

### GetNegativeOk

`func (o *VectorRecommendPointsRequest) GetNegativeOk() (*[]VectorDeletePointsRequestPointsInner, bool)`
...
`func (o *VectorRecommendPointsRequest) SetNegative(v []VectorDeletePointsRequestPointsInner)`
