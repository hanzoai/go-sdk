...
------------- | ------------- | -------------
[**AdminAdminAnalytics**](AdminMoneyAPI.md#AdminAdminAnalytics) | **Get** /v1/admin/analytics | Native SaaS analytics (retention/growth/churn)
[**AdminAdminFinance**](AdminMoneyAPI.md#AdminAdminFinance) | **Get** /v1/admin/finance | COGS / gross-margin / runway dashboard
[**AdminAdminRevenue**](AdminMoneyAPI.md#AdminAdminRevenue) | **Get** /v1/admin/revenue | Fleet revenue aggregate
...
func main() {
	...
	resp, r, err := apiClient.AdminMoneyAPI.AdminAdminAnalytics(context.Background()).Range_(range_).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AdminMoneyAPI.AdminAdminAnalytics``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AdminAdminAnalytics`: AdminAdminAnalytics200Response
	fmt.Fprintf(os.Stdout, "Response from `AdminMoneyAPI.AdminAdminAnalytics`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdminMoneyAPI.AdminAdminFinance(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AdminMoneyAPI.AdminAdminFinance``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AdminAdminFinance`: AdminAdminFinance200Response
	fmt.Fprintf(os.Stdout, "Response from `AdminMoneyAPI.AdminAdminFinance`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.AdminMoneyAPI.AdminAdminRevenue(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `AdminMoneyAPI.AdminAdminRevenue``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `AdminAdminRevenue`: AdminAdminRevenue200Response
	fmt.Fprintf(os.Stdout, "Response from `AdminMoneyAPI.AdminAdminRevenue`: %v\n", resp)
}
```
