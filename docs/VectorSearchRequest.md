...
------------ | ------------- | ------------- | -------------
**Vector** | [**VectorSearchRequestVector**](VectorSearchRequestVector.md) |  | 
...
**WithPayload** | Pointer to [**VectorSearchRequestWithPayload**](VectorSearchRequestWithPayload.md) |  | [optional] 
**WithVector** | Pointer to [**VectorSearchRequestWithPayload**](VectorSearchRequestWithPayload.md) |  | [optional] 
...
`func NewVectorSearchRequest(vector VectorSearchRequestVector, ) *VectorSearchRequest`
...
`func (o *VectorSearchRequest) GetVector() VectorSearchRequestVector`

GetVector returns the Vector field if non-nil, zero value otherwise.

### GetVectorOk

`func (o *VectorSearchRequest) GetVectorOk() (*VectorSearchRequestVector, bool)`
...
`func (o *VectorSearchRequest) SetVector(v VectorSearchRequestVector)`
...
`func (o *VectorSearchRequest) GetWithPayload() VectorSearchRequestWithPayload`

GetWithPayload returns the WithPayload field if non-nil, zero value otherwise.

### GetWithPayloadOk

`func (o *VectorSearchRequest) GetWithPayloadOk() (*VectorSearchRequestWithPayload, bool)`
...
`func (o *VectorSearchRequest) SetWithPayload(v VectorSearchRequestWithPayload)`
...
`func (o *VectorSearchRequest) GetWithVector() VectorSearchRequestWithPayload`

GetWithVector returns the WithVector field if non-nil, zero value otherwise.

### GetWithVectorOk

`func (o *VectorSearchRequest) GetWithVectorOk() (*VectorSearchRequestWithPayload, bool)`
...
`func (o *VectorSearchRequest) SetWithVector(v VectorSearchRequestWithPayload)`
