...
func main() {
	...
	resp, r, err := apiClient.IssuesAPI.TrackerCreateIssue(context.Background(), key).TrackerCreateIssueRequest(trackerCreateIssueRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IssuesAPI.TrackerCreateIssue``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `TrackerCreateIssue`: TrackerIssue
	fmt.Fprintf(os.Stdout, "Response from `IssuesAPI.TrackerCreateIssue`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.IssuesAPI.TrackerDeleteIssue(context.Background(), key, num).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IssuesAPI.TrackerDeleteIssue``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IssuesAPI.TrackerGetIssue(context.Background(), key, num).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IssuesAPI.TrackerGetIssue``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `TrackerGetIssue`: TrackerIssue
	fmt.Fprintf(os.Stdout, "Response from `IssuesAPI.TrackerGetIssue`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IssuesAPI.TrackerListIssues(context.Background(), key).Status(status).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IssuesAPI.TrackerListIssues``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `TrackerListIssues`: []TrackerIssue
	fmt.Fprintf(os.Stdout, "Response from `IssuesAPI.TrackerListIssues`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.IssuesAPI.TrackerUpdateIssue(context.Background(), key, num).TrackerUpdateIssueRequest(trackerUpdateIssueRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `IssuesAPI.TrackerUpdateIssue``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `TrackerUpdateIssue`: TrackerIssue
	fmt.Fprintf(os.Stdout, "Response from `IssuesAPI.TrackerUpdateIssue`: %v\n", resp)
}
```
