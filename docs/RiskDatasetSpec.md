...
**From** | Pointer to **string** | From and To bound the event window, half-open, RFC 3339. The window may not be longer than the source&#39;s own retention: past that, its older half is already gone and the dataset would silently be shorter than it says. | [optional] 
