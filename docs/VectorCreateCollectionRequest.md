...
`func (o *VectorCreateCollectionRequest) GetVectors() VectorCreateCollectionRequestVectors`

GetVectors returns the Vectors field if non-nil, zero value otherwise.

### GetVectorsOk

`func (o *VectorCreateCollectionRequest) GetVectorsOk() (*VectorCreateCollectionRequestVectors, bool)`
...
`func (o *VectorCreateCollectionRequest) SetVectors(v VectorCreateCollectionRequestVectors)`
