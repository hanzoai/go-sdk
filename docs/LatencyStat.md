...
**P50Ms** | Pointer to **float64** | median latency over the window | [optional] 
**P95Ms** | Pointer to **float64** | 95th-percentile latency | [optional] 
**P99Ms** | Pointer to **float64** | 99th-percentile latency | [optional] 
