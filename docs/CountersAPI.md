...
func main() {
	...
	resp, r, err := apiClient.CountersAPI.CommerceGetDailyDashboard(context.Background()).CommerceGetDailyDashboardRequest(commerceGetDailyDashboardRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CountersAPI.CommerceGetDailyDashboard``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CommerceGetDailyDashboard`: map[string]interface{}
	fmt.Fprintf(os.Stdout, "Response from `CountersAPI.CommerceGetDailyDashboard`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CountersAPI.CommerceGetProductCounters(context.Background(), productid).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CountersAPI.CommerceGetProductCounters``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CommerceGetProductCounters`: map[string]interface{}
	fmt.Fprintf(os.Stdout, "Response from `CountersAPI.CommerceGetProductCounters`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CountersAPI.CommerceGetToplineMetrics(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CountersAPI.CommerceGetToplineMetrics``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CommerceGetToplineMetrics`: map[string]interface{}
	fmt.Fprintf(os.Stdout, "Response from `CountersAPI.CommerceGetToplineMetrics`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.CountersAPI.CommerceSearchCounters(context.Background()).CommerceSearchCountersRequest(commerceSearchCountersRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `CountersAPI.CommerceSearchCounters``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `CommerceSearchCounters`: map[string]interface{}
	fmt.Fprintf(os.Stdout, "Response from `CountersAPI.CommerceSearchCounters`: %v\n", resp)
}
```
