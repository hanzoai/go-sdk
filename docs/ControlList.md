...
------------ | ------------- | ------------- | -------------
**Absent** | Pointer to **int32** | Absent is how many the organization does not have. Each still names the clause it would satisfy, and none of them moves a coverage number. | [optional] 
...
**Partial** | Pointer to **int32** | Partial is how many run but do not cover their whole claim. | [optional] 
...
**Unverified** | Pointer to **int32** | Unverified is how many rest on somebody having read the source rather than on a test or an audit row. | [optional] 
