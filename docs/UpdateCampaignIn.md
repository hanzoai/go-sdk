...
`func (o *UpdateCampaignIn) GetBudget() int32`

GetBudget returns the Budget field if non-nil, zero value otherwise.

### GetBudgetOk

`func (o *UpdateCampaignIn) GetBudgetOk() (*int32, bool)`
...
`func (o *UpdateCampaignIn) SetBudget(v int32)`
...
`func (o *UpdateCampaignIn) GetSpend() int32`

GetSpend returns the Spend field if non-nil, zero value otherwise.

### GetSpendOk

`func (o *UpdateCampaignIn) GetSpendOk() (*int32, bool)`
...
`func (o *UpdateCampaignIn) SetSpend(v int32)`
