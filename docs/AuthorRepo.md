...
**CreatedAt** | Pointer to **int32** | CreatedAt is unix seconds when the claim was first recorded. It equals verifiedAt on the first proof and then stays put while verifiedAt moves, so the pair reads as \&quot;claimed since / last proven\&quot;. | [optional] 
...
**VerifiedAt** | Pointer to **int32** | VerifiedAt is unix seconds of the most recent successful proof. Re-verifying refreshes it, and the method beside it, in place. | [optional] 
