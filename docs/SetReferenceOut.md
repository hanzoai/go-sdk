...
------------ | ------------- | ------------- | -------------
**Overrides** | Pointer to **int32** | Overrides is how many your org now holds in this set. | [optional] 
**Set** | Pointer to **string** | Set is the set written in. | [optional] 
**Written** | Pointer to **int32** | Written is how many entries this call wrote. | [optional] 
