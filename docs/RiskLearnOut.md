...
------------ | ------------- | ------------- | -------------
**Learned** | Pointer to **int32** | Learned is how many of the events the model actually learned from, and is also what the call is metered at: one screen per event learned from. It is the batch minus the events already in this organisation&#39;s record, so a retried batch reports — and is charged — zero. | [optional] 
