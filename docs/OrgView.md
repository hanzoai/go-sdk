...
**CreatedAt** | Pointer to **int32** | CreatedAt is unix seconds when the owner claim was first recorded — equal to verifiedAt on the first proof, then fixed while verifiedAt moves. | [optional] 
...
**VerifiedAt** | Pointer to **int32** | VerifiedAt is unix seconds of the most recent successful proof of the owner; re-verifying refreshes it, and the method beside it, in place. | [optional] 
