...
**Learned** | Pointer to **int64** | Learned is how many events are behind the masses. | [optional] 
**Sequence** | Pointer to **int64** | Sequence is this value&#39;s place in YOUR organisation&#39;s own history, from 1 and contiguous until retention disposes of the oldest. | [optional] 
