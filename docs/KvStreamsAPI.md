...
------------- | ------------- | -------------
[**KvStreamAdd**](KvStreamsAPI.md#KvStreamAdd) | **Post** /v1/kv/streams/{key}/add | Add entry to stream
[**KvStreamInfo**](KvStreamsAPI.md#KvStreamInfo) | **Get** /v1/kv/streams/{key}/info | Get stream info
[**KvStreamRead**](KvStreamsAPI.md#KvStreamRead) | **Get** /v1/kv/streams/{key} | Read stream entries
...
func main() {
	...
	resp, r, err := apiClient.KvStreamsAPI.KvStreamAdd(context.Background(), key).KvStreamAddRequest(kvStreamAddRequest).Namespace(namespace).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `KvStreamsAPI.KvStreamAdd``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `KvStreamAdd`: KvStreamAdd201Response
	fmt.Fprintf(os.Stdout, "Response from `KvStreamsAPI.KvStreamAdd`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KvStreamsAPI.KvStreamInfo(context.Background(), key).Namespace(namespace).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `KvStreamsAPI.KvStreamInfo``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `KvStreamInfo`: KvStreamInfo200Response
	fmt.Fprintf(os.Stdout, "Response from `KvStreamsAPI.KvStreamInfo`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.KvStreamsAPI.KvStreamRead(context.Background(), key).Start(start).End(end).Count(count).Namespace(namespace).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `KvStreamsAPI.KvStreamRead``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `KvStreamRead`: KvStreamRead200Response
	fmt.Fprintf(os.Stdout, "Response from `KvStreamsAPI.KvStreamRead`: %v\n", resp)
}
```
