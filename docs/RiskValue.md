...
------------ | ------------- | ------------- | -------------
**Baseline** | Pointer to **float32** | Baseline is what Observed was measured against: this organisation&#39;s own history for this subject. | [optional] 
...
**Observed** | Pointer to **float32** | Observed is the raw number X was computed from, quoted so the coordinate reads back as a sentence rather than a bare ratio. | [optional] 
**Unit** | Pointer to **string** | Unit is how to read Observed. | [optional] 
**X** | Pointer to **float32** | X is the coordinate in the model space, always dimensionless. | [optional] 
