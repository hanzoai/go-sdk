...
**Revoked** | Pointer to **int32** | Revoked is how many links this call revoked. | [optional] 
**SessionsStopped** | Pointer to **int32** | SessionsStopped is how many of the caller&#39;s own agent sessions stopped. A stop that fails does not fail the revoke, so this may honestly report fewer. | [optional] 
