...
// AllowanceAPIService AllowanceAPI service
type AllowanceAPIService service

type AllowanceAPIGetAllowanceRequest struct {
	ctx        context.Context
...
/*
GetAllowance Answers what the CALLER has left of their plan's free-call allowance this period, and the instant the count starts again.
...
A named handler, not a closure, so zipdoc can lift this prose into the registry.
	...
	@return AllowanceAPIGetAllowanceRequest
*/
func (a *AllowanceAPIService) GetAllowance(ctx context.Context) AllowanceAPIGetAllowanceRequest {
	return AllowanceAPIGetAllowanceRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *AllowanceAPIService) GetAllowanceExecute(r AllowanceAPIGetAllowanceRequest) (*Allowance, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/allowance"
