...
// checks if the CloudCompany type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CloudCompany{}

// CloudCompany struct for CloudCompany
...
func (o CloudCompany) MarshalJSON() ([]byte, error) {
...
func (o CloudCompany) ToMap() (map[string]interface{}, error) {
...
type NullableCloudCompany struct {
	value *CloudCompany
	isSet bool
}

func (v NullableCloudCompany) Get() *CloudCompany {
	return v.value
}

func (v *NullableCloudCompany) Set(val *CloudCompany) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudCompany) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudCompany) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudCompany(val *CloudCompany) *NullableCloudCompany {
	return &NullableCloudCompany{value: val, isSet: true}
}

func (v NullableCloudCompany) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudCompany) UnmarshalJSON(src []byte) error {
	v.isSet = true
