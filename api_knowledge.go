...
type KnowledgeAPIPostKnowledgeReindexRequest struct {
	ctx        context.Context
	ApiService *KnowledgeAPIService
}
...
The request has no body. Response: {"vectors": 412, "lexical": 412, "removed": 3, "failed": 0}
	...
	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return KnowledgeAPIPostKnowledgeReindexRequest
*/
func (a *KnowledgeAPIService) PostKnowledgeReindex(ctx context.Context) KnowledgeAPIPostKnowledgeReindexRequest {
	return KnowledgeAPIPostKnowledgeReindexRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *KnowledgeAPIService) PostKnowledgeReindexExecute(r KnowledgeAPIPostKnowledgeReindexRequest) (*ReindexOut, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/knowledge/reindex"
