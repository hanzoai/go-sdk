...
// checks if the O11yO11yUser type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &O11yO11yUser{}
...
func (o O11yO11yUser) MarshalJSON() ([]byte, error) {
...
func (o O11yO11yUser) ToMap() (map[string]interface{}, error) {
...
func (v NullableO11yO11yUser) Get() *O11yO11yUser {
	return v.value
}

func (v *NullableO11yO11yUser) Set(val *O11yO11yUser) {
	v.value = val
	v.isSet = true
}

func (v NullableO11yO11yUser) IsSet() bool {
	return v.isSet
}

func (v *NullableO11yO11yUser) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableO11yO11yUser(val *O11yO11yUser) *NullableO11yO11yUser {
	return &NullableO11yO11yUser{value: val, isSet: true}
}

func (v NullableO11yO11yUser) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableO11yO11yUser) UnmarshalJSON(src []byte) error {
	v.isSet = true
